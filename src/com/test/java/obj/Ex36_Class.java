	...
	public static void main(String[] args) {
		...
		/*
			...
			2. 클래스, Class
				...
				ex) 붕어빵, 붕어빵틀
					a. 붕어빵틀을 만든다. > '클래스'
					b. a를 사용해서 붕어빵을 만든다. > 실체화된 제품, 결과물이 => '객체'
					c. 붕어빵을 먹는다.
			...
			5. 인터페이스
				- 캡슐화된 내부와 외부간의 최소한의 연결이 가능한 통로 역할(ex. 리모콘에서의 버튼, 사람의 눈코입)
				ex) 게임 인터페이스
		...
		*/
		...
		//	b. 한 쌍의 집합 > 물리적 관리 불가능(x의 짝꿍이 y인지 y2인지 경험으로 알 뿐, 정확하게 두개가 한 쌍이라는걸 증명할 수 없음.)
		// - 구조(X), 규칙(애매) > 조작 불편
		...
		// - 배열 단점 > 요소간 성질을 구분하기 힘들다. > 첨자 사용 > 첨자는 의미를 가지지 못한다 > 몇번째 방에 어떤 데이터를 넣었는지 관리 힘들다. > 배열은 같은 타입의 같은 성질의 데이터 집합
...
//배열은 같은 자료형의 집합밖에 못 넣으나, class는 다른 자료형 넣을 수 있음!
class Size {
	public String name;
	public int width;
	public int height;
